...
write.csv(rLearnedScores,file="C:/Users/hessor/Documents/pcgaussiantesting/CG-Testing/Metrics/r_pc_learned_original_cg_metrics_testing_comp_pat.csv",row.names=FALSE)
